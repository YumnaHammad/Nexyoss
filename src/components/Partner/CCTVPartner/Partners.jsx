...
const Partners = () => {
  ...
  useEffect(() => {
    const fetchSectionData = async () => {
      try {
        const response = await fetch("https://nexyos.deeptech.pk/api/cctv-partner/section-2");
              ...
              >
                ...
                <div style={pageStyles.statsContainer}>
                  ...
                  >
                    ...
                    <div style={pageStyles.statNumber}>{sectionData.sub_heading1}</div>
                  ...
                  >
                    ...
                    <div style={pageStyles.statNumber}>{sectionData.sub_heading2}</div>
                  ...
                  >
                    ...
                    <div style={pageStyles.statNumber}>{sectionData.sub_heading3}</div>
